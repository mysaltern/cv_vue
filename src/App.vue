        ...
        <header id="site_header" class="header mobile-menu-hide">
          <div class="header-content">
            <div class="header-photo">
              <img src="src/assets/img/mohammad.jpeg" alt="Mohammad Saltanatpouri" />
            </div>
          ...
          <ul class="main-menu">
            ...
            <li>
              <a href="#blog" class="nav-anim">
                ...
                <span class="link-text">Sample</span>
              </a>
            </li>
            <li>
            ...
            <div class="page-title">
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-7">
                  ...
                  <div class="timeline timeline-second-style clearfix">
                    <div class="timeline-item clearfix">
                      <div class="left-part">
                        ...
                        <span class="item-company">University of Payame noor</span>
                      </div>
                      <div class="divider"></div>
                      <div class="right-part">
                        <h4 class="item-title">Information Technology</h4>
                    ...
                    <div class="timeline-item clearfix">
                      <div class="left-part">
                        <h5 class="item-period">2018- correct</h5>
                        <span class="item-company"> of Studies</span>
                      </div>
                      <div class="divider"></div>
                      <div class="right-part">
                  ...
                  <div class="timeline timeline-second-style clearfix">
                    <div class="timeline-item clearfix">
                      <div class="left-part">
                        <h5 class="item-period">2018- correct</h5>
                        <span class="item-company">AVIN Co</span>
                      </div>
                      <div class="divider"></div>
                      <div class="right-part">
                  ...
                  <div class="timeline timeline-second-style clearfix">
                    <div class="timeline-item clearfix">
                      <div class="left-part">
                        ...
                        <span class="item-company">Ecomiran Co</span>
                      </div>
                      <div class="divider"></div>
                      <div class="right-part">
                        <h4 class="item-title">Senior Backend Developer</h4>
                    ...
                    <div class="timeline-item clearfix">
                      <div class="left-part">
                        <h5 class="item-period">2015 - 2016</h5>
                        <span class="item-company">Sharif University</span>
                      </div>
                      <div class="divider"></div>
                      <div class="right-part">
                    ...
                    <div class="timeline-item clearfix">
                      <div class="left-part">
                        <h5 class="item-period">2013 - 2015</h5>
                        <span class="item-company">Fajar Co</span>
                      </div>
                      <div class="divider"></div>
                      <div class="right-part">
                        <h4 class="item-title">Junior Ui Developer</h4>
                ...
                <div class="col-xs-12 col-sm-5">
                  ...
                  <!-- Coding Skills -->
                  <div class="block-title">
                    <h3>Another <span>Skills</span></h3>
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-6">
                  <div class="certificate-item clearfix">
                    <div class="certi-logo">
                      <img src="src/assets/img/ashiyane.jpg" alt="logo">
                    </div>

                    <div class="certi-content">
                      <div class="certi-title">
                        <h4>Certified Ethical Hacker (CEH) Ashyane</h4>
                      </div>
                ...
                <div class="col-xs-12 col-sm-6">
                  <div class="certificate-item clearfix">
                    <div class="certi-logo">
                      <img src="src/assets/img/payamnoor.png" alt="logo">
                    </div>

                    <div class="certi-content">
                      <div class="certi-title">
                        <h4>Payame Noor University</h4>
                      </div>
         ...
         <!-- About Me Subpage -->
          <section data-id="about-me" class="animated-section">
            ...
            <div class="section-content">
                  ...
                  <div class="info-list">
                    <ul>
                      ...
                      <li>
                        ...
                        <span class="value">IRAN</span>
                      </li>

                      <li>
                        <span class="title">Address</span>
                        <span class="value">Tehran, Iran</span>
                      </li>

                      <li>
                        <span class="title">e-mail</span>
                        <span class="value"><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                            data-cfemail="">mysaltern@gmail.com</a></span>
                      </li>

                      <li>
                        <span class="title">Phone</span>
                        <span class="value">+989336086658</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-xs-12 col-sm-12">
                  <div class="clients owl-carousel categoryS1">

                    <div class="client-block">
                      <a href="#" target="_blank" title="Logo">
                        <img class="stdLogo" src="img/sabapal.png" alt="Sabapal">
                      </a>
                    </div>

                    <div class="client-block">
                      <a href="#" target="_blank" title="Logo">
                        <img class="stdLogo" src="img/ecomiran.png" alt="ecomiran">
                      </a>
                    </div>

                    <div class="client-block">
                      <a href="#" target="_blank" title="Logo">
                        <img class="stdLogo" src="img/cabin.png" alt="Logo">
                      </a>
                    </div>

                    <div class="client-block">
                      <a href="#" target="_blank" title="Logo">
                        <img class="stdLogo" src="img/asemanrayane.png" alt="Logo">
                      </a>
                    </div>

                    <div class="client-block">
                      <a href="#" target="_blank" title="Logo">
                        <img class="stdLogo" src="img/clients/client-5.png" alt="Logo">
                      </a>
                    </div>

                    <div class="client-block">
                      <a href="#" target="_blank" title="Logo">
                        <img class="stdLogo" src="img/clients/client-6.png" alt="Logo">
                      </a>
                    </div>

                    <div class="client-block">
                      <a href="#" target="_blank" title="Logo">
                        <img class="stdLogo" src="img/clients/client-7.png" alt="Logo">
                      </a>
                    </div>
                ...
                <div class="col-xs-12 col-sm-4">
                  ...
                  <div class="lm-info-block gray-default">
                    ...
                    <h4><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                        data-cfemail="">mysaltern@gmail.com</a></h4>
                    <span class="lm-info-block-value"></span>
                    <span class="lm-info-block-text"></span>
                  </div>
