                    ...
                    <div class="timeline-item clearfix">
                      <div class="left-part">
                        ...
                        <span class="item-company"
                          >University of Payame noor</span
                        >
                      </div>
                    ...
                    <div class="clients owl-carousel categoryS1">
                      <div class="client-block">
                        <a href="#" target="_blank" title="Logo">
                          <img
                            class="stdLogo"
                            src="src/assets/img/sabapal.png"
                            alt="Sabapal"
                          />
                        </a>
                      </div>
                      ...
                      <div class="client-block">
                        <a href="#" target="_blank" title="Logo">
                          <img
                            class="stdLogo"
                            src="src/assets/img/ecomiran.png"
                            alt="ecomiran"
                          />
                        </a>
                      </div>
                      ...
                      <div class="client-block">
                        <a href="#" target="_blank" title="Logo">
                          <img
                            class="stdLogo"
                            src="src/assets/img/asemanrayane.png"
                            alt="Logo"
                          />
                        </a>
                      </div>
